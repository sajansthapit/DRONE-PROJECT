...
import com.sajansthapit.medicationservice.exceptionhandler.exceptions.HttpFailedException;
...
public class HttpClientWrapper {
    ...
    public <T> T post(String url, String body, Map<String, String> queryParams, Class<T> clazz, String exceptionMessage) {
        try {
